...
type Order struct {
	...
	AppointmentIsLate                 bool       `json:"appointment_is_late" gorm:"default:false;comment:预约到店是否迟到"`
	AppointmentDepositAmount          float64    `json:"appointment_deposit_amount" gorm:"type:decimal(10,2);default:0;comment:预约金原额"`
