...
exports.saveImageByUrl = exports.dataUrlToBlob = exports.openImagePreviewWindow = exports.buildOrderCareReportFileName = exports.buildReceiptFileName = exports.isAppleSafariBrowser = void 0;
...
exports.isAppleSafariBrowser = isAppleSafariBrowser;
function buildReceiptFileName(orderNo) {
    const safeOrderNo = sanitizeFileNamePart(orderNo) || 'receipt';
    return `小票_${safeOrderNo}.png`;
}
exports.buildReceiptFileName = buildReceiptFileName;
...
async function resolveImageBlob(src) {
...
async function saveImageByUrl(src, fileName, options = {}) {
...
exports.saveImageByUrl = saveImageByUrl;
