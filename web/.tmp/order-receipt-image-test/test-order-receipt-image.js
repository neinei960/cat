...
(0, strict_1.default)(source.includes('navigator.share') || source.includes('window.open('), 'receipt save flow should provide a mobile Safari fallback instead of relying only on a.download');
